...
- Identify coding conventions (naming, structure, error handling) start in CODEX.md (or CLAUDE.md if present) AGENTS.md or relevant rules files such as .cursorrules
