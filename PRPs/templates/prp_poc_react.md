...
description: |
  Use this template with the OpenAI codex CLI.
  Reference commands in `.codex/commands/` when guiding codex during execution.
...
# [OK] POC loads without errors
# [OK] Primary user flow navigable
# [OK] Key interactions work with mock data
# [OK] UI renders correctly on desktop/mobile
# [OK] Mock data displays realistically
...
# [OK] Demo script prepared with key talking points
# [OK] Mock data scenarios cover realistic use cases
# [OK] Known limitations documented and communicated
# [OK] Next steps and production requirements identified

# Feedback gathering
# [OK] Stakeholder feedback session conducted
# [OK] User reaction/understanding assessed
# [OK] Concept validation questions answered
# [OK] Decision-making criteria evaluated

# Documentation and next steps
# [OK] POC findings documented
# [OK] Production implementation requirements identified
# [OK] Follow-up actions defined
```
...
- X **Don't over-engineer**: Skip complex architecture patterns for POC
- X **Don't implement full error handling**: Focus on happy path demonstration
- X **Don't create comprehensive test suites**: Basic smoke tests only
- X **Don't optimize for performance**: Functionality over optimization
- X **Don't integrate real APIs**: Mock data exclusively
- X **Don't build production features**: Prototype-level implementation only

### Process Anti-Patterns

- X **Don't expand scope during development**: Stick to defined "Must Have" items
- X **Don't perfect the UI**: Good enough for concept validation
- X **Don't implement edge cases**: Focus on primary user journey
- X **Don't build for scalability**: Single-user, demo-focused

### Communication Anti-Patterns

- X **Don't present as production-ready**: Clear POC expectations
- X **Don't hide limitations**: Transparent about what's mocked/limited
- X **Don't promise specific timelines**: POC findings inform estimates
- X **Don't skip documentation**: Future developers need context

### DO Focus On

- [OK] **Concept validation**: Can stakeholders evaluate the core idea?
- [OK] **User journey demonstration**: Primary flow works end-to-end
- [OK] **Visual concept clarity**: UI effectively communicates the concept
- [OK] **Realistic data scenarios**: Mock data represents actual usage
- [OK] **Fast iteration**: Prioritize speed of development and feedback cycles
- [OK] **Clear limitations**: Document assumptions and constraints
- [OK] **Next step clarity**: Production requirements and recommendations
