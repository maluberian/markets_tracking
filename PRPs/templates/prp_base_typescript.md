...
- X Don't create new patterns when existing ones work
- X Don't skip validation because "it should work"
- X Don't ignore failing tests - fix them
- X Don't use 'use client' unnecessarily - embrace Server Components
- X Don't hardcode values that should be config
- X Don't catch all exceptions - be specific
