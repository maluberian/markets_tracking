...
- X Vague requirements without acceptance criteria
- X Missing edge cases and error scenarios
- X Diagrams that don't match the text
- X Technical jargon without explanation
- X Unrealistic timelines
- X No success metrics

## Success Indicators
- [OK] Another developer could implement from this PRD alone
- [OK] All stakeholders understand the plan
- [OK] Risks are identified with mitigations
- [OK] Clear path from current state to desired state
- [OK] Diagrams clarify rather than confuse
