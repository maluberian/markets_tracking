...
description: "Template for converting user stories into executable implementation tasks using the OpenAI codex CLI (see `.codex/commands/`)."
---
...
- **VALIDATE**: ` uv run python -c "from services.user_service import UserService; print('[OK] Import successful')"`
...
- **VALIDATE**: `grep -q "user_router" api/routes.py && echo "[OK] Router added"`
...
- **VALIDATE**: `uv run python -m pytest tests/user_service_test.py && echo "[OK] Tests passed"`
